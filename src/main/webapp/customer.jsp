...
<head>
    ...
    <style>
        ...
        input[type="text"], input[type="number"], input[type="tel"] { width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; }
        ...
        .error-message { text-align: center; font-weight: bold; margin-bottom: 15px; color: red; } /* Added Red Error Style */
    </style>
</head>
<body>
<div class="container">
